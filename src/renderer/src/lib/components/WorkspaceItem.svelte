...
<style>
  ...
  .workspace-item:hover { background: var(--bg-deep); }
  .workspace-item.active { background: var(--accent-bg-subtle); }
  ...
  .workspace-item:hover .drag-handle { color: var(--text-muted); }
